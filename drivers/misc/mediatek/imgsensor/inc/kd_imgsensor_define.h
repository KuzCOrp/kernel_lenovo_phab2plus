...
typedef enum {
	...
	MSDK_SCENARIO_ID_MULTI_CAMERA_CAPTURE_JPEG,
	MSDK_SCENARIO_ID_MULTI_CAMERA_PREVIEW,
	MSDK_SCENARIO_ID_ZSL_PREVIEW,
	MSDK_SCENARIO_ID_MULTI_CAMERA_CAPTURE_PREVIEW,
	MSDK_SCENARIO_ID_CONTINUOUS_CAPTURE_JPEG,
	MSDK_SCENARIO_ID_HDR_CAPTURE_JPEG,
...
typedef struct {
	...
	MUINT16 SensorMultiCameraWidth;
	MUINT16 SensorMultiCameraHeight;
	MUINT16 SensorMultiPreviewWidth;
	MUINT16 SensorMultiPreviewHeight;
