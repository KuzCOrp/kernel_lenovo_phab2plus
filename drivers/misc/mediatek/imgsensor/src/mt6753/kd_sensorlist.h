...
#if defined(M12MO_YUV)
    {M12MO_SENSOR_ID, SENSOR_DRVNAME_M12MO_YUV, M12MO_YUV_SensorInit}, 
#endif

#if defined(M12MO_SUBSENSOR_YUV)
    {M12MO_SUBSENSOR_SENSOR_ID, SENSOR_DRVNAME_M12MO_SUBSENSOR_YUV, M12MO_SUBSENSOR_YUV_SensorInit}, 
#endif
