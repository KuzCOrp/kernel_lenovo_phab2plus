...
#define SENSOR_TYPE_CAPTOUCH               32
#define SENSOR_TYPE_HALLSWITCH               33
...
#define ID_HALLSWITCH                                        (ID_BASE+SENSOR_TYPE_HALLSWITCH-1)
#define ID_SENSOR_MAX_HANDLE	  (ID_BASE+SENSOR_TYPE_HALLSWITCH)
...
#define SENSOR_CAPTOUCH                        (1 << ID_CAPTOUCH) 
#define SENSOR_HALLSWITCH                        (1 << ID_HALLSWITCH) 
...
#define CAPTOUCH_PL_DEV_NAME                	"m_captouch_pl"
#define CAPTOUCH_INPUTDEV_NAME              "m_captouch_input"
#define CAPTOUCH_MISC_DEV_NAME              "m_captouch_misc"

#define HALLSWITCH_PL_DEV_NAME                	"m_hallswitch_pl"
#define HALLSWITCH_INPUTDEV_NAME              "m_hallswitch_input"
#define HALLSWITCH_MISC_DEV_NAME              "m_hallswitch_misc"
...
#define EVENT_SENSOR_CAPTOUCH			SENSOR_CAPTOUCH
#define EVENT_SENSOR_HALLSWITCH			SENSOR_HALLSWITCH
...
#define PA12200001_ALSPS_IOCTL_SET_CALI			_IOW(PA12200001_IOCTL_MAGIC, 0x6, int)
/*-----------------------------------------------------------------------------*/
