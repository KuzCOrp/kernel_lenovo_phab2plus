...
static void lcm_get_params(LCM_PARAMS *params)
{
       ...
       //1 SSD2075 has no TE Pin 
		...
		params->dsi.vertical_sync_active				= 1;//4;//1;  //---3
		params->dsi.vertical_backporch					= 9;//15;//9; //---14
		params->dsi.vertical_frontporch					= 14;//16;//8;  //----8
		params->dsi.vertical_active_line				= FRAME_HEIGHT; //1920

		params->dsi.horizontal_sync_active				= 4;//4;  //----2
		params->dsi.horizontal_backporch				= 36;//16;//32; //----28
		params->dsi.horizontal_frontporch				= 36;//24;//32; //----50
