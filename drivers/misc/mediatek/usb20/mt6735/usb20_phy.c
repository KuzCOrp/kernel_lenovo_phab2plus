...
//add by liutaifu20160627 modify the usb eye
	DBG(0,"usb phy read default eye value,ADDR:0x0d=0x%x\n",USBPHY_READ8(0x05));
	USBPHY_SET8(0x05, 0x56);
	DBG(0,"usb phy read default eye value,ADDR:0x0d=0x%x\n",USBPHY_READ8(0x05));
//end
...
void usb_phy_recover(void)
{
	...
	hs_slew_rate_cal();
//add by liutaifu modify the usb eye
	DBG(0,"usb phy read default eye value,ADDR:0x0d=0x%x\n",USBPHY_READ8(0x05));
	USBPHY_SET8(0x05,0x56);
	DBG(0,"usb phy read default eye value after set,ADDR:0x0d=0x%x\n",USBPHY_READ8(0x05));

	DBG(0,"usb phy read default rx sensitivity value,ADDR:0x18=0x%x\n",USBPHY_READ8(0x05));
