...
// O-film
#define MAX_LIMIT_VALUE_GROUP1 5200	//4500 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 900	//800		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 3600	//1500		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1600	//800		// key_val min limit
//#define UNIFORMITY_GROUP1 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
		0x00,0x38,0x04,0x80,0x07,0x0A,0x05,0x01,0x01,0x08,0x28,0x05,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x00,0x00,0x8F,0x2F,0x89,0x59,0x5B,0x31,0x0D,0x00,0x00,0x00,0x99,0x03,0x1D,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x00,0x00,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x00,0x20,0x48,0x70,0x00,0xF0,0x4A,0x3A,0xBB,0xBF,0x27,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x04,0x05,0x06,0x07,0x08,0x09,0x0C,0x0D,0x0E,0x0F,0x10,\
		0x11,0x14,0x15,0x16,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,0x13,0x12,0x11,0x10,0x0F,0x0D,0x0C,\
		0x0A,0x08,0x07,0x06,0x04,0x02,0x00,0x19,0x1B,0x1C,0x1E,0x1F,0x20,0x21,0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0xFF,0xFF,0x00,\
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF4,0x01\
    }

//TODO: define your config for Sensor_ID == 1 here, if needed
//mudong
#define MAX_LIMIT_VALUE_GROUP2 7400 	// screen max limit
...
#define MAX_LIMIT_VALUE_GROUP3 4400	// screen max limit
#define MIN_LIMIT_VALUE_GROUP3 900	// screen min limit
#define MAX_LIMIT_KEY_GROUP3 3900		// key_val max limit
#define MIN_LIMIT_KEY_GROUP3 1370		// key_val min limit
//#define UNIFORMITY_GROUP3 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP3 {\
		0x00,0x38,0x04,0x80,0x07,0x0A,0x34,0x01,0x01,0x0F,0x28,0x0F,0x50,0x3C,0x03,0x05,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x16,0x16,\
		0x1B,0x14,0x8F,0x2F,0x89,0x64,0x66,0x12,0x0C,0x00,0x00,0x00,0x02,0x32,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x19,0x32,0x82,0x94,0x45,0x02,0x00,0x00,0x00,0x04,0xC6,0x37,0x00,0xA5,0x42,0x00,0x85,0x50,0x00,0x6C,0x62,0x00,0x59,0x76,0x00,\
		0x59,0x20,0x48,0x70,0x00,0x57,0x55,0x40,0xFF,0xF0,0x17,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x04,0x05,0x06,0x07,0x08,0x09,0x0C,0x0D,0x0E,0x0F,0x10,\
		0x11,0x14,0x15,0x16,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,0x13,0x12,0x11,0x10,0x0F,0x0D,0x0C,\
		0x0A,0x08,0x07,0x06,0x04,0x02,0x00,0x19,0x1B,0x1C,0x1E,0x1F,0x20,0x21,0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0xFF,0xFF,0x00,\
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xD3,0x01\
		}
...
#define MAX_LIMIT_VALUE_GROUP6 5820 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP6 885		// screen min limit
...
#define CTP_TEST_CFG_GROUP6 {\
	0x00,0x38,0x04,0x80,0x07,0x05,0xF5,0x40,0x01,0x0A,0x1E,0x08,0x4B,0x37,0x0F,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,0x16,\
	0x20,0x14,0x8D,0x2D,0xAA,0x64,0x66,0xD3,0x07,0x00,0x00,0x00,0x03,0x02,0x1D,0x32,0x01,0x00,0x0F,0x14,0x1E,0x01,0x00,0x00,0x01,\
	0x0A,0x46,0x78,0x94,0x45,0x02,0x2D,0x00,0x00,0x04,0x8C,0x49,0x00,0x82,0x52,0x00,0x79,0x5B,0x00,0x71,0x66,0x00,0x6A,0x71,0x00,\
	0x6A,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,\
	0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x1E,0x1F,0x20,0x21,0x22,0x23,0x24,0x25,\
	0x26,0x27,0x28,0x29,0x2A,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x78,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x32,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFA,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x26,0x01\
    }
