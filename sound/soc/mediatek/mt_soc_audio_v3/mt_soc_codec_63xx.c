...
struct regulator *vcn18_main_mic_reg = NULL;
#endif
...
{
#if defined(CONFIG_SND_SOC_ES804_ESCORE)
	vcn18_main_mic_reg = regulator_get(&pdev->dev, "vMainMic");
	if (IS_ERR(vcn18_main_mic_reg))
		printk("regulator_get(vMainMic) failed!\n");
#endif
