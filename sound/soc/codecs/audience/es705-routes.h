...
static const u32 route_rec_stereo_pri_sec[] = {
	0xB00C0A00,//;
	0xB00D000F,//;
	0xB00C0A09,//;
	0xB00D0030,//;
...
static const u32 route_3chan_pcm_passthrough1[] = {
	0x804e0000, /* Set smooth rate to zero */
	0x8060002c,
	0x8060002d,
	0x8060002e,
...
static const u32 route_PT_mic0_portb[] = {
                0xB00C0B00,//;
                0xB00D000F,//;
                0xB00C0B09,//;
                0xB00D0030,//;
...
static const struct esxxx_route_config es705_route_config[ROUTE_MAX] = {
	...
	[ROUTE_CS_VOICE_HEADSET] = {
		.route = route_rec_stereo_pri_sec,
	},
	[ROUTE_CS_VOICE_1MIC_HEADPHONE] = {
	...
	[ROUTE_3CHAN_PCM_PT1] = {
		.route = route_3chan_pcm_passthrough1,
	},
	[ROUTE_3CHAN_PCM_PT] = {
